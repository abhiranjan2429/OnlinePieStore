...
namespace FoodOrderingApp.Models
{
    ...
    {
        private  List<ShoppingCartItem> value ;
        ...
        public IEnumerable<Pie> PiesOfTheWeek { get => AllPies.Where(a => a.IsPieOfTheWeek == true); }
        // public List<ShoppingCartItem> ShoppingCartItems { get { return value; } set { value= new List<ShoppingCartItem>(); } }
